# OmniQL FFI / C API Reference — v0.4.0
...
```c
const char* query =
    "{\"target\":\"users\",\"action\":\"FIND\",\"filter\":{\"$or\":[{\"status\":\"active\"},{\"score\":{\"$gt\":100}}]},\"options\":{\"limit\":10,\"sort\":{\"score\":-1},\"fields\":{\"name\":1,\"email\":1}}}";
...
```json
{
  ...
  "action":   "FIND",
  "filter":   { "$or": [ { "status": "active" }, { "score": { "$gt": 100 } } ] },
  "document": { "field": value },
  "options":  { "limit": 10, "skip": 0, "sort": { "score": -1 }, "fields": { "name": 1 } }
}
```
